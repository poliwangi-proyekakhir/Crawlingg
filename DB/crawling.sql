...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Apr 2020 pada 07.44
...
(2, 'sejin@n.com', 'sejina', 'sejin', 2, '2020-04-09 21:32:09', '2020-04-09 21:48:20');
...
--
ALTER TABLE `pengguna`
  MODIFY `id_pengguna` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
